...
---
## Dashboard Preview
![Executive Pulse](05-Assets/01-Executive-Pulse.png)
...
---
## Power BI Report
The final report is structured around a simple decision-making flow:
...
- Several sub-categories generated meaningful revenue without proportional profit, showing why performance should be evaluated on **profitability as well as sales**.
---
## Recommendations
...
---
## Project Outcome
The project demonstrates an end-to-end analytics workflow that moves beyond descriptive reporting to connect **business performance → profitability diagnosis → actionable recommendations**.
